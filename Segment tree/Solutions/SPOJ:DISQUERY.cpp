/*
 O((N + M) * log(N)) solution based on persistent segment trees
 Fast input and output techniques used for faster performance
 Binary lifitng method used for answering LCA queries
 */
