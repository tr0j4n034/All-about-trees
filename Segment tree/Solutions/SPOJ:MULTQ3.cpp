/*
 O(N + Q * log(N)) solution using segment trees
 Range updates is easy to handle, because only 3 cases there are to consider.
 Fast input and output techniques are used for better performance.
 */
