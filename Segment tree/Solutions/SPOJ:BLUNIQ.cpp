/*
 O(N*log(N)) solution using implicit segment trees
 There is a large constant due to initialization of nodes in every call.
 In order to cope with this problem, you can use static nodes as well.
 */
