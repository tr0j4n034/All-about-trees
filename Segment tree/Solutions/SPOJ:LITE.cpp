/*
 O(Q * log(N)) solution based on segment trees.
 One of the most popular problems when learning range updates(lazy propagation).
 Fast input ans output techniques are used for better performance
 */
