/*
 O((N + Q) * log(N)) solution using persistent segment trees
 Fast input and output used for better performance
 Coordinate compression used for eliminating extra log(N) factor
 LCA queries handled by using binary lifting method
 */
